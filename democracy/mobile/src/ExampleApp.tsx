  ...
  if (showDevScreen) {
    return (
      <SafeAreaView style={{ flex: 1 }}>
        ...
        <Button
          title="Back to App"
          onPress={() => setShowDevScreen(false)}
        />
      </SafeAreaView>
    );
  }
    ...
    <SafeAreaView style={{ flex: 1, padding: 20 }}>
      <View style={{ gap: 20 }}>
        <Button
          ...
          onPress={() => handleUserAction('button_pressed')}
        />
        
        <Button
          title="Simulate Feature Usage"
          onPress={simulateFeatureUsage}
        />
        
        <Button
          title="Simulate Error"
          onPress={() => handleError(new Error('Test error'))}
        />
        
        {/* Dev Mode Screen - only show in development */}
        {__DEV__ && (
          <Button
            title="Open Dev Logs Screen"
            onPress={() => setShowDevScreen(true)}
          />
        )}
      </View>
    </SafeAreaView>
