...
export default {
  ...
  CRON_PROCEDURES: testCronTime(process.env.CRON_PROCEDURES) ? process.env.CRON_PROCEDURES : undefined,
  CRON_NAMED_POLLS: testCronTime(process.env.CRON_NAMED_POLLS) ? process.env.CRON_NAMED_POLLS : undefined,
  CRON_DEPUTY_PROFILES: testCronTime(process.env.CRON_DEPUTY_PROFILES) ? process.env.CRON_DEPUTY_PROFILES : undefined,
  CRON_SHEDULE_BIO_RESYNC: testCronTime(process.env.CRON_SHEDULE_BIO_RESYNC)
    ? process.env.CRON_SHEDULE_BIO_RESYNC
    : undefined,
  CRON_SEND_QUED_PUSHS: testCronTime(process.env.CRON_SEND_QUED_PUSHS) ? process.env.CRON_SEND_QUED_PUSHS : undefined,
