...
### 0.2.78-alpha-chore-knip.0 (2025-11-08)

### 0.2.77 (2025-11-04)

### 0.2.77-alpha-chore-fix-release.1 (2025-11-04)

### 0.2.77-alpha-chore-fix-release.0 (2025-11-04)

### 0.2.77-alpha-chore-knip.0 (2025-11-02)
...
### 0.2.71-alpha-chore-yarn-to-pnpm.0 (2025-11-02)

### 0.2.70 (2025-11-01)

### 0.2.69 (2025-11-01)

### 0.2.69-alpha-chore-yarn-to-pnpm.3 (2025-11-01)

### 0.2.69-alpha-chore-yarn-to-pnpm.2 (2025-11-01)

### 0.2.69-alpha-chore-yarn-to-pnpm.1 (2025-11-01)

### 0.2.69-alpha-chore-yarn-to-pnpm.0 (2025-11-01)

### 0.2.69-alpha.2 (2025-11-01)

### 0.2.69-alpha.1 (2025-11-01)

### 0.2.69-alpha.0 (2025-11-01)
...
* add conference weeks for 2025 ([d9fade8](https://github.com/demokratie-live/democracy-api/commit/d9fade8904b78db974725f644657f7f788798c34))
...
* 🐛 filter empty deputies ([#2](https://github.com/demokratie-live/democracy-api/issues/2)) ([a733389](https://github.com/demokratie-live/democracy-api/commit/a733389a8b190745b6d22b41925c759e1af7bb08))
